...
'''
Question: how many SNP positions are the same (shared) between individuals versus unique? 
...
def main():
    ...
    with open('/home/sagrant/encrypt_genome/data/unique_positions.csv', 'w') as outFile: 
